...
describe("Test Messages", () => {
  ...
  describe("Test Cabinet Message", () => {
    ...
    test("test cabinet", done => {
      const cabinetMessage = new CabinetMessage("123", messageType.MATRIX_CABINET, cabinetMessageType.OPEN_BINS_AND_DRAWER, [
        {
          IP: "192.168.127.100",
          Port: "8001",
          Drawer: 1,
  ...
  describe("Camera: ", () => {
    beforeAll(done => {
      const cameraMessage = new CameraMessage("123", messageType.MATRIX_CAMERA, cameraMessageType.LOGIN, {
        ...
        UserName: "root",
        Password: "matrix",
        FilePath: "C://KeyTag//Matrix 2.0//TestsFiles//MatrixService//Camera//Records",
        BackFilePath: "",
        FileType: "asf",
        FileName: "test - axis - 1"
      }, false, cameraStatusResponse.NONE);
    ...
    afterAll(done => {
      setTimeout(() => {
        const cameraMessage = new CameraMessage("123", messageType.MATRIX_CAMERA, cameraMessageType.STOP_RECORDING, {
          CameraType: CameraType.AXIS,
          IP: "192.168.127.96",
          Port: 80,
          UserName: "root",
    ...
    test("should record", done => {
      const cameraMessage = new CameraMessage("123", messageType.MATRIX_CAMERA, cameraMessageType.START_RECORDING, {
        CameraType: CameraType.AXIS,
        IP: "192.168.127.96",
        Port: 80,
        UserName: "root",
